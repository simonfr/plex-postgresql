...
### Fixed
- **Git repository size** — removed accidentally committed `rust/sql-translator/target/` from all history via `git-filter-repo`. Repository size reduced from 243MB to 60MB.
